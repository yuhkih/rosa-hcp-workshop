...
ここの手順は、ドキュメントの「![Creating a Vritual Private Cloud for your ROSA with HCP clusters](https://docs.openshift.com/rosa/rosa_hcp/rosa-hcp-sts-creating-a-cluster-quickly.html#rosa-hcp-creating-vpc)」をベースにしています。
